...
# -*- coding: utf-8 -*-
#
# vix documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'vix.tex', 'vix Documentation',
     'Author', 'manual'),
]
...
man_pages = [
    (master_doc, 'vix', 'vix Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'vix', 'vix Documentation',
     author, 'vix', 'One line description of project.',
     'Miscellaneous'),
]
